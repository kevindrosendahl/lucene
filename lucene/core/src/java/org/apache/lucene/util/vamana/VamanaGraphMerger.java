 ...
 * @lucene.experimental
 */
public interface VamanaGraphMerger {
   ...
   */
  VamanaGraphMerger addReader(KnnVectorsReader reader, MergeState.DocMap docMap, Bits liveDocs)
      throws IOException;
   ...
   */
  OnHeapVamanaGraph merge(DocIdSetIterator mergedVectorIterator, InfoStream infoStream, int maxOrd)
      throws IOException;
}
