 ...
 * @lucene.experimental
 */
public final class VectorSandboxHnswVectorsFormat extends KnnVectorsFormat {

  static final String META_CODEC_NAME = "VectorSandboxHnswVectorsFormatMeta";
  static final String VECTOR_DATA_CODEC_NAME = "VectorSandboxHnswVectorsFormatData";
  static final String VECTOR_INDEX_CODEC_NAME = "VectorSandboxHnswVectorsFormatIndex";
   ...
   * node. Defaults to to {@link VectorSandboxHnswVectorsFormat#DEFAULT_BEAM_WIDTH}. See {@link
   * HnswGraph} for details.
   */
  private final int beamWidth;

  /** Constructs a format using default graph construction parameters */
  public VectorSandboxHnswVectorsFormat() {
  ...
  public KnnVectorsWriter fieldsWriter(SegmentWriteState state) throws IOException {
    return new VectorSandboxHnswVectorsWriter(state, maxConn, beamWidth);
  }

  @Override
  public KnnVectorsReader fieldsReader(SegmentReadState state) throws IOException {
    return new VectorSandboxHnswVectorsReader(state);
  }
